...
After signing in, you'll be looking at the [Calendar view](./views#calendar-view) with today selected.
...
You will now see the "Try out LyfeSchedule" [task](./tasks).

## Edit a task

Actually, this shouldn't take more than 5 minutes. Let's [edit the task](./tasks#edit-a-task) to change the estimate.
...
Look at that, you've tried out LyfeSchedule! So now you can [complete the task](./tasks#complete-a-task).
...
One of the most powerful features is [repeating tasks](./tasks#repeating-tasks) - these are tasks that re-occur after a
...
your day, it's common to intentionally [postpone a task](./tasks#postpone-a-task) to a later day - whether something came up,
...
- Review the recommended approach for adding tasks: [Add tasks gradually based on your responsibilities and goals](./recommendations#add-tasks-gradually-based-on-your-responsibilities-and-goals)
  {/* - Customize the app to your liking: [Settings](./settings) */}
