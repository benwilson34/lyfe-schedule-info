...
perfect fit for [repeating tasks](./tasks.md#repeating-tasks).
...
Use the [time estimate](./tasks.md#time-estimate) field as much as possible. This forces you to imagine
