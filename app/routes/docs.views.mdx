...
<Callout type="info">Planned feature: different sort modes</Callout>
...
<Callout type="info">
  Considered feature: allow the user to configure this projection calculation,
  for example by using the average complete date instead of the first available
  complete date.
</Callout>

<Callout type="info">
  Considered feature: for a given repeating task, show a list of the next
